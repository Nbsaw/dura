...
const Timeline: TimelineType = {
  "2021 (新生的一年)": [
    {
      time: "05月17日",
      text: "已经上班一阵子了，感觉就是忙，但是也不是很忙，大部分时间都在学习不知道的东西，比如流程，代码，平台，其实还是蛮有新鲜感的。也是觉得自己在各个方面都还有提升的空间，有点烦恼自身能力还不够强吧。",
    },
    {
      time: "04月23日",
      text: "面试过了，准备去拉拉布拉多了。",
    ...
    {
      time: "04月18日",
      text: "明天就要面试了，脑壳疼，有点紧张，还有好多东西没复习完 ...",
    },
    {
      time: "04月17日",
      text: "似乎找到了前进的意义",
    ...
    {
      time: "04月16日",
      text: ["依旧是复习中，前端可以考的东西可真多啊 0.0"],
    },
    {
      time: "04月15日",
      text: [
        "找个时间把体检做了，最近把刷手机的时间戒掉吧。公寓的网络真的慢，这真的是光纤么? 还时不时断掉 ...",
        "今天的目标是刷够百分之40的题目。买了个XMind会员，不能贴图实在是太难受了。",
      ],
    },
    {
      time: "04月14日",
